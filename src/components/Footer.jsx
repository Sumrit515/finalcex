...
const Footer = () => {
    ...
    return(
        ...
        // </div>
        // <footer class="bg-gradient-to-r from-gray-800 via-[#bce1ff] to-gray-100">
        <footer class="  bg-gradient-to-r from-[#020314] via-blue-900 to-[#020314]">
